...
def main(today=True):
    ...
    with sync_playwright() as p:
        ...
        for accordion in soup.find_all("li", class_="accordion--generic js-toggle"):
            ...
            if title_el and not ("UK & Irish Racing" in title_el.text.strip()):
                sections.append(accordion)
                break
        if sections:
            for section in sections:
                for race_div in section.find_all("div", class_="cell--link race-grid-col"):
            ...
            print("[WARN] No race sections found.")
